...
SERVICE_PRICE_DOLLARS = SERVICE_PRICE_EUROS/0.82
...
def process_client(clientsocket):
    ...
    send_message += "The change in dollars is %i$ $" % SERVICE_PRICE_DOLLARS
    send_message += "OS QUIERO GUAPIS"
...
try:
    ...
    while True:
        ...
        (clientsocket, address) = serversocket.accept() #bloquea el server hasta que arrives the client
